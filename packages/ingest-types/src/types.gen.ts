...
export type GetModelPreviewError = GetModelPreviewErrors[keyof GetModelPreviewErrors];
...
export type GetModelPreviewResponse = GetModelPreviewResponses[keyof GetModelPreviewResponses];
...
export type CreateAssetExportData = {
    body: {
         ...
         *
         */
        naming_strategy?: 'group_by_job_id' | 'prepend_job_id' | 'preserve' | 'asset_id';
        /**
...
export type UpdateAssetTagsError = UpdateAssetTagsErrors[keyof UpdateAssetTagsErrors];
...
export type UpdateAssetTagsResponse = UpdateAssetTagsResponses[keyof UpdateAssetTagsResponses];
...
export type GetSettingByKeyError = GetSettingByKeyErrors[keyof GetSettingByKeyErrors];
...
export type GetSettingByKeyResponse = GetSettingByKeyResponses[keyof GetSettingByKeyResponses];
...
export type UpdateSettingByKeyError = UpdateSettingByKeyErrors[keyof UpdateSettingByKeyErrors];
...
export type UpdateSettingByKeyResponse = UpdateSettingByKeyResponses[keyof UpdateSettingByKeyResponses];
